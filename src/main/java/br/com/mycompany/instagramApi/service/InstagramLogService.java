...
import br.com.mycompany.instagramApi.repository.InstagramLogRepository;

@Service
@Transactional(propagation = Propagation.REQUIRED)
public class InstagramLogService extends BaseService<InstagramUser> {

	@Autowired
	InstagramLogRepository repository;

	@Override
	public InstagramLogRepository getRepository() {
		return repository;
	}
